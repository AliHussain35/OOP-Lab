...
class Currency{
	...
	public:
		Currency(float a, string code, string symbol, float r){
			amount = a;
			currencyCode = code;
...
class Dollar : public Currency{
	public:
		Dollar(float a, string code, string symbol, float r) : Currency(a, code, symbol, r){
		};
...
class Euro : public Currency{
	public:
		Euro(float a, string code, string symbol, float r) : Currency(a, code, symbol, r){
		};
...
class Rupee : public Currency{
	public:
		Rupee(float a, string code, string symbol, float r) : Currency(a, code, symbol, r){
		};
